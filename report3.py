...
if __name__ == "__main__":
    ...
    generate_overview_report(
        ...
        output_path="./daily_reports/tenant_overview_report_0423.xlsx"
    )

    exit()

    date_list = date_range("2025-04-23", "2025-04-23")
    for date in date_list:
        ...
        report_manager = ReportManager(output_dir="./daily_reports3", tenant_mapping_path="./data/processed/tenant_info/tenant_terminalId_mappingtable_nancy34.xlsx")
